...
[Here](UB_intro/UB_intro.html) is a set of slides presenting the main features of the theme. 

The source code of the presentation is [here](https://github.com/lrberge/ub_theme/blob/main/UB_intro/UB_intro.Rmd).
...
The transition quickly revealed to be painful however. I wanted the stuff to look in a certain way and knew I had to invest a bit of time on customization. I initially thought my journey was only about writing a few lines of CSS code. I couldn't be more wrong.
